          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="flex flex-col">
              ...
              <div className="flex gap-4 mb-6">
                <Link href="https://youtube.com" aria-label={t('footer.social.youtube')}>
                ...
                <Link href="https://twitter.com" aria-label={t('footer.social.twitter')}>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <Link href="https://discord.com" aria-label={t('footer.social.discord')}>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <Link href="https://github.com" aria-label={t('footer.social.github')}>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <Link href="https://telegram.org" aria-label={t('footer.social.telegram')}>
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition-colors">
                    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
