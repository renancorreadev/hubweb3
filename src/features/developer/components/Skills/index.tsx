...
import { Body, Heading2, Typography } from "@/components/Typography";
          ...
          {[...Array(8)].map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                backgroundColor: `${getBorderColor()}${Math.floor(
                  Math.random() * 50 + 20
                )}`,
                top: `${Math.random() * 100}%`,
...
const TechBadge = ({ tech, delay }: TechBadgeProps) => {
  ...
  return (
    <div className="relative" title={tech.description || ""}>
      <motion.div
        ref={badgeRef}
      ...
      >
        <div className="relative">
          <div 
            ...
            style={{
              backgroundImage: isDark ? "radial-gradient(circle at 50% 50%, rgba(153, 69, 255, 0.15), transparent 70%)" : "radial-gradient(circle at 50% 50%, rgba(122, 53, 204, 0.08), transparent 70%)",
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: isDark
                ...
                : "0 4px 20px rgba(0, 0, 0, 0.1)",
              border: `1px solid ${
                isDark ? "rgba(40, 40, 60, 0.5)" : "rgba(230, 230, 230, 1)"
              }`,
            }}
            animate={{
              y: isHovered ? -8 : 0,
          ...
          >
            <div className="relative w-full h-full flex items-center justify-center">
              <Image
                ...
                alt={tech.name}
                fill
                className={`object-contain p-2 ${!isDark ? "filter invert" : ""}`}
        ...
        <div className="text-center mt-1">
          <Typography
            variant="small"
            className={`font-semibold text-base md:text-lg ${isDark ? "text-hub-primary" : "text-gray-800"}`}
          >
            {tech.name}
          </Typography>
        </div>
  ...
  const techIcons = [
    {
      ...
      category: "blockchain",
      description:
        "Desenvolvimento de DApps, contratos inteligentes e tokens (ERC20, ERC721, ERC1155)",
      level: 95,
    },
    {
      name: "Solana",
      ...
      category: "blockchain",
      description:
        "Desenvolvimento de programas em Rust e integração com carteiras e NFTs",
      level: 85,
    },
    {
      name: "Solidity",
      ...
      category: "blockchain",
      description:
        "Linguagem para contratos inteligentes na EVM com foco em segurança e otimização de gas",
      level: 95,
    },
    {
      name: "Hyperledger",
      ...
      category: "blockchain",
      description:
        "Frameworks para blockchains empresariais e redes permissionadas",
      level: 80,
    },
    {
      name: "Rust",
      ...
      category: "language",
      description:
        "Linguagem de programação de alto desempenho para blockchains como Solana e Polkadot",
      level: 85,
    },
    {
      name: "Go",
      ...
      category: "language",
      description:
        "Linguagem de programação para sistemas distribuídos, APIs e microserviços",
      level: 90,
    },
    {
      name: "Node.js",
      ...
      category: "backend",
      description:
        "Desenvolvimento de servidores, APIs RESTful e integração com blockchains",
      level: 95,
    },
    {
      name: "TypeScript",
    ...
    },
    {
      ...
      category: "blockchain",
      description:
        "Indexação e consulta de dados de blockchain através de GraphQL",
      level: 85,
    },
    {
      name: "Next.js",
  ...
  return (
    ...
    >
      <div className="px-4 md:px-6 lg:px-8 relative z-10">
        ...
        >
          <Heading2>{t("developer.skills.title")}</Heading2>
          <motion.div
          ...
          />
          <Body>{t("developer.skills.description")}</Body>
        </motion.div>
        ...
        <motion.div
          ...
          style={{
            ...
            backdropFilter: "blur(8px)",
            border: `1px solid ${
              isDark ? "rgba(30, 30, 40, 0.3)" : "rgba(220, 220, 230, 0.8)"
            }`,
          }}
