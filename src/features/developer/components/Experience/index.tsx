...
export const Experience = () => {
  ...
  useEffect(() => {
    ...
    const nodeElements = timelineRef.current.querySelectorAll('.blockchain-node');
  ...
  return (
    <section
      className={`py-24 relative overflow-hidden ${isDark ? 'dark' : 'light'}`}
      style={{
        backgroundColor: isDark ? 'rgba(8, 8, 12, 0.97)' : 'rgba(248, 250, 252, 0.95)',
    ...
    >
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            backgroundImage: `radial-gradient(circle at 20% 30%, ${isDark ? 'rgba(153, 69, 255, 0.07)' : 'rgba(122, 53, 204, 0.05)'}, transparent 25%)`,
          }}
        />
        <div 
          className="absolute inset-0" 
          style={{
            backgroundImage: `radial-gradient(circle at 80% 70%, ${isDark ? 'rgba(20, 241, 149, 0.05)' : 'rgba(16, 185, 129, 0.03)'}, transparent 25%)`,
          }}
        />
        
        {/* Partículas de fundo */}
        <BlockchainParticles active={true} intensity={0.5} className="opacity-30" />
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <Typography variant="body">
              Minha trajetória desenvolvendo soluções blockchain, desde contratos inteligentes até infraestruturas completas para aplicações descentralizadas.
            </Typography>
          </motion.div>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="w-full lg:w-2/3">
            {/* Decorativo - Título de blockchain */}
            <div className="flex items-center mb-6 space-x-2">
              ...
              <div className="px-2 py-1 rounded-md text-xs font-mono" style={{
                backgroundColor: isDark ? 'rgba(35, 35, 40, 0.8)' : 'rgba(240, 240, 245, 0.8)',
                border: `1px solid ${isDark ? 'rgba(153, 69, 255, 0.3)' : 'rgba(122, 53, 204, 0.2)'}`,
              }}>
                {chainInitializedRef.current ? "ONLINE" : "SYNCING..."}
              </div>
            </div>
            
            {/* Decorativo - Linha do tempo com indicadores de hash */}
            <div className="mb-6 flex items-center overflow-x-auto pb-2 scrollbar-hide">
              <div 
                className="flex items-center px-3 py-2 rounded-md mr-3 text-xs font-mono"
                style={{
                  backgroundColor: isDark ? 'rgba(30, 30, 35, 0.7)' : 'rgba(245, 245, 250, 0.9)',
              ...
              >
                <svg width="16" height="16" className="mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="3" y="14" width="7" height="7" rx="1" stroke="currentColor" strokeWidth="2"/><rect x="14" y="14" width="7" height="7" rx="1" stroke="currentColor" strokeWidth="2"/><path d="M10 6.5H14" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><path d="M10 17.5H14" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><path d="M6.5 10V14" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/><path d="M17.5 10V14" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                </svg>
              ...
              {experienceData.slice(0, 5).map((exp, i) => (
                <motion.div
                  ...
                  style={{
                    backgroundColor: isDark ? 'rgba(30, 30, 35, 0.7)' : 'rgba(245, 245, 250, 0.9)',
                    border: `1px solid ${minedNodesRef.current[i] ? (isDark ? '#14F195' : '#10B981') : (isDark ? 'rgba(153, 69, 255, 0.3)' : 'rgba(122, 53, 204, 0.2)')}`,
                  }}
                  ...
                  <div className="flex items-center">
                    <div 
                      className={`w-2 h-2 rounded-full mr-2 ${
                        minedNodesRef.current[i] ? 'bg-green-400' : 'bg-gray-400'
                      }`}
                    />
              ...
              {experienceData.length > 5 && (
                <div className="text-xs font-mono opacity-50">+{experienceData.length - 5} more</div>
              )}
            </div>
            ...
            >
              ...
              <motion.div 
                ...
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: chainInitializedRef.current ? 1 : 0, y: chainInitializedRef.current ? 0 : -10 }}
          ...
          <div className="w-full lg:w-1/3">
            <div className="space-y-8">
              ...
              >
                <div className="text-sm p-3 rounded-lg mb-0"
                  style={{
                    background: isDark ? 'linear-gradient(135deg, rgba(153, 69, 255, 0.1), rgba(20, 241, 149, 0.05))' : 'linear-gradient(135deg, rgba(122, 53, 204, 0.05), rgba(16, 185, 129, 0.02))',
                    border: isDark ? '1px dashed rgba(153, 69, 255, 0.3)' : '1px dashed rgba(122, 53, 204, 0.2)'
                  }}
                >
                  ...
                  <ul className="space-y-2 opacity-90 text-xs">
                    <li>• Clique na <b>seta circular</b> em qualquer bloco para expandir detalhes</li>
                    <li>• Ao expandir, o bloco inicia a <b>mineração</b> (simulando uma blockchain real)</li>
                    <li>• Os <b>dados hash</b> e campos de bloco mostram detalhes técnicos da blockchain</li>
                    <li>• Cada bloco representa uma <b>experiência profissional</b> na cadeia</li>
                  </ul>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                style={{ 
                  borderColor: isDark ? 'rgba(153, 69, 255, 0.2)' : 'rgba(122, 53, 204, 0.1)',
                  background: isDark 
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    >
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 15L8.5 11.5L9.91 10.09L12 12.17L18.18 6L19.59 7.41L12 15Z" fill="white"/>
                        <path d="M19 3H5C3.89 3 3 3.9 3 5V19C3 20.1 3.89 21 5 21H19C20.11 21 21 20.1 21 19V5C21 3.9 20.11 3 19 3ZM19 19H5V5H19V19Z" fill="white"/>
                      </svg>
                    </div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 font-mono text-sm">
                    <div className="p-3 rounded-lg" style={{
                      ...
                      <span className="font-bold">Career Blockchain (EXPR)</span>
                    </div>
                    <div className="p-3 rounded-lg" style={{
                      backgroundColor: isDark ? 'rgba(30, 30, 35, 0.5)' : 'rgba(245, 245, 250, 0.8)',
                      borderLeft: `3px solid ${isDark ? '#9945FF' : '#7A35CC'}`,
                      ...
                      <span className="font-bold">Proof of Work Experience</span>
                    </div>
                    <div className="p-3 rounded-lg" style={{
                      backgroundColor: isDark ? 'rgba(30, 30, 35, 0.5)' : 'rgba(245, 245, 250, 0.8)',
                      borderLeft: `3px solid ${isDark ? '#14F195' : '#10B981'}`,
                      ...
                      <span className="font-bold">{(minedBlocksCount + 1) * 12.73}.5 TH/s</span>
                    </div>
                    <div className="p-3 rounded-lg" style={{
                      backgroundColor: isDark ? 'rgba(30, 30, 35, 0.5)' : 'rgba(245, 245, 250, 0.8)',
                      borderLeft: `3px solid ${isDark ? '#14F195' : '#10B981'}`,
                      ...
                      <span className="font-bold flex items-center">
                        <span className="mr-2">{minedBlocksCount} / {experienceData.length}</span>
                        {minedBlocksCount > 0 && (
                          <span 
                  ...
                  <div className="mt-4">
                    <div className="text-xs mb-1 flex justify-between">
                      ...
                      <span>{Math.round((minedBlocksCount / experienceData.length) * 100)}%</span>
                    </div>
                    <div className="h-2 w-full rounded-full overflow-hidden" style={{
                      backgroundColor: isDark ? 'rgba(40, 40, 45, 0.5)' : 'rgba(230, 230, 235, 0.8)',
                    }}>
                      <motion.div 
                        ...
                        initial={{ width: `${(minedBlocksCount / experienceData.length) * 100}%` }}
                        animate={{ width: `${(minedBlocksCount / experienceData.length) * 100}%` }}
                        transition={{ duration: 0.5 }}
                      />
                    </div>
                  </div>
