        ...
        <div className="mb-12 md:mb-20">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            >
              ...
              {subtitle && (
                <p className="text-xl mt-2 text-hub-primary dark:text-hub-primary">{subtitle}</p>
              )}
            </motion.div>
            ...
            >
              <Link href="/projects" className="px-4 py-2 rounded-full border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors flex items-center gap-2 text-black dark:text-white">
              ...
              {tags.map((tag, index) => (
                <span
                  ...
                  style={{
                    ...
                    border: `1px solid ${isDark ? "rgba(20, 241, 149, 0.3)" : "rgba(14, 166, 107, 0.3)"}`,
                  }}
                >
                  {tag}
                </span>
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold mb-4 text-black dark:text-white">{t("projects.description")}</h3>
              ...
              {techStack.length > 0 && (
                <div className="space-y-4">
                  <h3 className="text-2xl font-bold mb-4 text-black dark:text-white">{t("projects.technologies")}</h3>
                ...
                {githubUrl && (
                  <a
                    ...
                    style={{
                      ...
                      border: `1px solid ${isDark ? "rgba(153, 69, 255, 0.3)" : "rgba(122, 53, 204, 0.3)"}`,
                    }}
                  >
